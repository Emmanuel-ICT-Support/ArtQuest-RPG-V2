...
const GUIDE_TABS: GuideTab[] = [
  {
    ...
    keyPoints: [
      ...
      'Choose New Game to select a Class Pack, then build a fresh artist profile.',
  ...
  },
  {
    ...
    shortTitle: 'Class Pack',
    explanation: 'Before choosing an avatar, select the ArtQuest experience prepared for the class. This determines whether the journey uses the default gallery, a preloaded class pack, or a teacher-provided JSON Class Pack.',
    keyPoints: [
      'Default ArtQuest starts the original gallery experience for Years 7–12.',
      'Find a Class opens the available preloaded Class Packs for the student to choose from.',
      'Import a Class Pack lets students open the JSON file supplied by their teacher.',
      'Select Default ArtQuest, then choose Continue to move on to the avatar setup screen.',
    ],
    screenshotSrc: './public/images/screens/choose-your-class-screen.png',
    screenshotAlt: 'ArtQuest Choose Your Class screen showing Default ArtQuest, Find a Class, Import a Class Pack, Return to Menu, and Continue.',
    callouts: [
      { number: 1, label: 'Default ArtQuest', description: 'Select the original gallery artworks and questions for Years 7–12.', left: '28.7%', top: '52.5%' },
      { number: 2, label: 'Find a Class', description: 'Opens the list of preloaded Class Packs prepared for students.', left: '49.4%', top: '52.5%' },
      { number: 3, label: 'Import a Class Pack', description: 'Choose the teacher-provided JSON Class Pack file to open it.', left: '70.6%', top: '52.5%' },
      { number: 4, label: 'Continue', description: 'After selecting Default ArtQuest, continues to avatar setup.', left: '63.5%', top: '90.8%' },
    ],
  },
  {
    id: 'artist-setup',
    title: 'Artist Setup',
    shortTitle: 'Setup',
    explanation: 'After choosing a Class Pack, choose the learning level, select or build an avatar, and personalise the artist name before entering the map.',
    keyPoints: [
  ...
  },
  {
    ...
    title: 'Assessment',
    shortTitle: 'Assess',
    explanation: 'Assessment Summary turns completed journal evidence into formative estimates across key Visual Arts skills, with a rubric and detailed feedback for every wing.',
    keyPoints: [
      'The rubric adapts to the selected level or pathway and describes each achievement band.',
      'Complete wings and journal entries to unlock estimated scores.',
      'Select a completed wing for personalised feedback and next steps.',
      'Scores are formative; teachers confirm final marks.',
    ],
    screenshotSrc: './public/images/screens/guide/assessment.png',
    screenshotAlt: 'ArtQuest Assessment Summary showing the assessment overview, rubric table, score column, and Detailed Wing Feedback buttons.',
    callouts: [
      { number: 1, label: 'Assessment Overview', description: 'Explains that the rubric provides formative estimates and teachers confirm final marks.', left: '50%', top: '15%' },
      { number: 2, label: 'Assessment Criteria', description: 'Rows show the five Visual Arts skills assessed from journal evidence.', left: '7.5%', top: '56%' },
      { number: 3, label: 'Achievement Levels', description: 'Columns describe evidence from Excellent through to Not Demonstrated.', left: '49%', top: '34.5%' },
      { number: 4, label: 'Average Score', description: 'Shows the estimated level for each criterion after completed wings are recorded.', left: '93%', top: '56%' },
      { number: 5, label: 'Detailed Wing Feedback', description: 'Select a completed wing to see personalised feedback and next steps.', left: '50%', top: '84.5%' },
    ],
  },
  {
    id: 'side-quests-pip',
