...
const LEVEL_DOOR_POSITIONS_BY_GALLERY: DoorPosition[][] = [
  [
    { left: '17.5%', top: '8%', width: '13.5%', height: '27.5%' },
    { left: '43%', top: '6%', width: '14%', height: '29%' },
    { left: '70%', top: '8%', width: '13.5%', height: '27.5%' },
  ],
  [
    { left: '20%', top: '4%', width: '10.5%', height: '28%' },
    { left: '45%', top: '2%', width: '10.5%', height: '30%' },
    { left: '70.5%', top: '4%', width: '11%', height: '28%' },
  ],
  [
    { left: '18.5%', top: '5.4%', width: '10%', height: '28.7%' },
    { left: '44%', top: '6.9%', width: '10.2%', height: '28%' },
    { left: '70%', top: '8%', width: '10%', height: '26%' },
  ],
  [
    { left: '17%', top: '6%', width: '14.5%', height: '28.5%' },
    { left: '43%', top: '4%', width: '15%', height: '30%' },
    { left: '68.5%', top: '7%', width: '14%', height: '27%' },
  ],
];

const LEVEL_DOOR_COUNT = LEVEL_DOOR_POSITIONS_BY_GALLERY[0].length;
...
const GALLERY_SPAWN: Point = { x: 50, y: 58 };
...
const FOYER_FIXED_BLOCKING_RECTS: Rect[] = [
  { x: 8.5, y: 2.1, width: 83.5, height: 23.2 },
  { x: 8.4, y: 25.7, width: 2.4, height: 70.5 },
  { x: 90.6, y: 25.3, width: 2.1, height: 70.4 },
  { x: 11.2, y: 20.5, width: 4.4, height: 9.4 },
  { x: 86.1, y: 20.1, width: 3.4, height: 10.9 },
  { x: 30.6, y: 21.6, width: 4.6, height: 20.4 },
  { x: 67.4, y: 21.7, width: 4.7, height: 20.7 },
  { x: 30.1, y: 47.4, width: 2.7, height: 10.3 },
  { x: 69.5, y: 48, width: 2.8, height: 9.6 },
  { x: 16.3, y: 79.5, width: 26.9, height: 15.6 },
  { x: 60.6, y: 79.7, width: 25, height: 16.3 },
  { x: 10.9, y: 92.2, width: 5.4, height: 3.8 },
...
const GALLERY_FIXED_BLOCKING_RECTS_BY_INDEX: Rect[][] = [
  [
    { x: 11.2, y: 1.9, width: 77.3, height: 26.2 },
    { x: 10.8, y: 28.6, width: 2, height: 67.8 },
    { x: 13, y: 93.9, width: 76.6, height: 2.6 },
    { x: 34.5, y: 26.8, width: 3.8, height: 18.4 },
    { x: 61.7, y: 26.8, width: 3.8, height: 18.8 },
    { x: 31.4, y: 40.5, width: 2.5, height: 10 },
    { x: 65.7, y: 41.6, width: 2.7, height: 9.4 },
    { x: 43.4, y: 78.2, width: 13.2, height: 19.1 },
    { x: 79.8, y: 41, width: 9.4, height: 5.7 },
    { x: 76, y: 47, width: 13.3, height: 16.5 },
    { x: 75.8, y: 72.9, width: 13.9, height: 5 },
    { x: 87.6, y: 78.2, width: 1.9, height: 15.2 },
  ],
  [
    { x: 7.4, y: 1.4, width: 12.9, height: 25.2 },
    { x: 20.2, y: 3.8, width: 25, height: 22.4 },
    { x: 45, y: 2, width: 47.2, height: 23 },
    { x: 7.5, y: 27, width: 2.4, height: 70.9 },
    { x: 90.4, y: 25.7, width: 1.9, height: 73 },
    { x: 33.3, y: 22.6, width: 6.2, height: 23.6 },
    { x: 61.5, y: 25.2, width: 5.4, height: 20.6 },
    { x: 30.2, y: 34.5, width: 2.9, height: 8.6 },
    { x: 67.2, y: 34.8, width: 2.8, height: 8.4 },
    { x: 82.2, y: 38.3, width: 8.3, height: 7.1 },
    { x: 79.9, y: 45.6, width: 11.4, height: 20.2 },
    { x: 80.3, y: 77.3, width: 10.1, height: 5.5 },
    { x: 44.3, y: 76.7, width: 11.3, height: 19.8 },
    { x: 38.9, y: 86, width: 5.1, height: 11.2 },
    { x: 56.2, y: 86.4, width: 5.1, height: 9.7 },
    { x: 7.5, y: 95.2, width: 82.6, height: 3.7 },
  ],
  [
    { x: 9.4, y: 2.4, width: 8.8, height: 31.6 },
    { x: 9, y: 34.1, width: 2, height: 64.8 },
    { x: 18.5, y: 5.4, width: 9.9, height: 20 },
    { x: 44, y: 6.9, width: 10.2, height: 19.2 },
    { x: 70, y: 8, width: 9.8, height: 18.1 },
    { x: 79.7, y: 2, width: 9.6, height: 31 },
    { x: 28.3, y: 12.1, width: 15.3, height: 33.7 },
    { x: 54, y: 9.5, width: 15.8, height: 36.5 },
    { x: 77.6, y: 42, width: 8.7, height: 19.6 },
    { x: 86.8, y: 40.4, width: 3.6, height: 31.8 },
    { x: 87.4, y: 33.5, width: 2.3, height: 6.7 },
    { x: 11.4, y: 71.9, width: 5.6, height: 21.6 },
    { x: 82.7, y: 71.9, width: 5.9, height: 21.6 },
    { x: 43.7, y: 77.6, width: 10.9, height: 16.4 },
    { x: 37.1, y: 80.9, width: 6.3, height: 13 },
    { x: 54.7, y: 81.1, width: 6.3, height: 13.2 },
    { x: 11.6, y: 96.8, width: 78.5, height: 2.6 },
  ],
  [
    { x: 7.2, y: 1.2, width: 85.3, height: 24.3 },
    { x: 6.9, y: 25.3, width: 1.7, height: 73 },
    { x: 91.5, y: 25.3, width: 1.8, height: 72.8 },
    { x: 15, y: 24.9, width: 7.9, height: 9.7 },
    { x: 26.3, y: 25.3, width: 22, height: 9.5 },
    { x: 51.5, y: 25.6, width: 22, height: 8.6 },
    { x: 76.7, y: 24.9, width: 8.1, height: 9.9 },
    { x: 31.6, y: 34.6, width: 8.7, height: 7.2 },
    { x: 59.8, y: 34.5, width: 8.7, height: 7.7 },
    { x: 57, y: 43.6, width: 5.2, height: 5.5 },
    { x: 31.8, y: 47.9, width: 5.9, height: 6.1 },
    { x: 62.4, y: 50.4, width: 6, height: 5.9 },
    { x: 36.3, y: 55.4, width: 5.9, height: 6.3 },
    { x: 68.2, y: 57.7, width: 6.1, height: 7.1 },
    { x: 42.4, y: 74.1, width: 15.2, height: 23.5 },
    { x: 37.7, y: 79.7, width: 4.1, height: 14.2 },
    { x: 57.5, y: 80, width: 4.6, height: 13.8 },
    { x: 8.6, y: 95.2, width: 84.3, height: 3.2 },
  ],
];

// Right-side gallery doorway blockers are folded into the per-gallery rectangles above.
...
const getLevelDoorPosition = (galleryIndex: number, doorIndex: number): DoorPosition => (
  LEVEL_DOOR_POSITIONS_BY_GALLERY[galleryIndex]?.[doorIndex]
  || LEVEL_DOOR_POSITIONS_BY_GALLERY[0][doorIndex]
  || LEVEL_DOOR_POSITIONS_BY_GALLERY[0][0]
);

const getDoorGuardPoint = (doorIndex: number, galleryIndex = 0): Point => {
  const doorRect = doorRectFromPosition(getLevelDoorPosition(galleryIndex, doorIndex));
  const isRightmostDoor = doorIndex === LEVEL_DOOR_COUNT - 1;
...
const getDoorInteractionPoint = (doorIndex: number, galleryIndex = 0): Point => {
  const doorEntryRect = doorEntryRectFromPosition(getLevelDoorPosition(galleryIndex, doorIndex));
...
export const MapScreen: React.FC<MapScreenProps> = ({
  ...
  const getNavigationPromptTargets = (): NavigationPromptTarget[] => {
    ...
    if (scene === 'foyer') {
      ...
      activeGallery.wingIds.forEach((wingId, doorIndex) => {
        ...
        const promptPoint = isGuardedDoor
          ? getDoorGuardPoint(doorIndex, activeGallery.index)
          : getDoorInteractionPoint(doorIndex, activeGallery.index);
        ...
        addTarget({
          ...
          placement: doorIndex === LEVEL_DOOR_COUNT - 1 ? 'left' : 'right',
  ...
  const getClosestActiveGalleryWing = (): { wingId: string; distance: number } | null => {
    ...
    const closestDoor = activeGallery.wingIds
      .map((wingId, doorIndex) => {
        const doorRect = doorRectFromPosition(getLevelDoorPosition(activeGallery.index, doorIndex));
        const talkPoint = {
  ...
  const renderLevelDoor = (wingId: string, doorIndex: number, galleryIndex: number) => {
    const wing = getWingById(wingId);
    if (!wing) return null;
    ...
    const position = getLevelDoorPosition(galleryIndex, doorIndex);
    ...
    return (
      <section className="flex h-full w-full items-center justify-center">
        ...
        >
          ...
          {activeGallery.wingIds.map((wingId, doorIndex) => renderLevelDoor(wingId, doorIndex, galleryIndex))}
          {renderSideQuestClues()}
          {renderDoorGuards()}
          {renderSceneNpcs()}
          {renderPip()}
